...
<body>
    ...
    <section class="breadcrumb-section set-bg" data-setbg="../img/index4.jpg">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 order-lg-2 col-md-6 p-0">
                    <div class="ss-text">
                        ...
                        <p>Whether you’re new to exercising or the gym is your second home, working with a personal trainer can help you reach your health and fitness goals. </p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 order-lg-4 col-md-6 p-0">
                    <div class="ss-text">
                        ...
                        <p>Group Fitness offers a range of class formats, including cardio, strength, cycling & more. It is a great way to meet new people and stay active! Classes are free the first two days of subscribing. </p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 order-lg-7 col-md-6 p-0">
                    <div class="ss-text second-row">
                        <h4>Body building</h4>
                        <p>Bodybuilding, a regimen of exercises designed to enhance the human body’s muscular development and promote general health and fitness.</p>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-8">
                    <div class="ps-item">
                        ...
                        <a href="#" class="primary-btn pricing-btn">Subscribe</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-8">
                    <div class="ps-item">
