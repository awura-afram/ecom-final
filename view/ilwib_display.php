...
$select_ilwib = select_all_ilwib_ctr();
// print_r($select_ilwib);
?>
<!DOCTYPE html>
<html lang="zxx">
...
<body>
    ...
    <section class="team-section team-page spad">
        <div class="container">
            ...
            <div class="row">
                <?php
                foreach ($select_ilwib as $ilwib) {

                ?>
                    <div class="col-lg-4 col-sm-6">
                        <div class="ts-item set-bg" data-setbg="<?php echo $ilwib['product_image'] ?>">
                            <div class="ts_text">
                                <h4><?php echo $ilwib['product_title'] ?></h4>
                                <div class="tt_social">
                                    <a href="#">easy</a>
                                    <a href="#">tank-top</a>
                                    <a href="#">split</a>
                                ...
                                <br>
                                <h4>GHS <?php echo $ilwib['product_price'] ?></h4>
                                <a href="../actions/add_cart.php?p_id=<?php echo $ilwib['product_id'] ?>">Add to Cart</a>
                            </div>
                        </div>
                    </div>
                <?php
