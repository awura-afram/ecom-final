                ...
                <div class="col-lg-6">
                    <div class="leave-comment">
                        <form action="./registerprocess.php" method="POST">
                            ...
                            <input type="number" name="pnum" id="number" placeholder="Phone Number">
                            <input type="email" name="email" id="email" placeholder="Email Address">
                            <input type="password" name="password" id="password" placeholder="Password">
                            <input type="password" name="confirmpassword" id="confirmpassword" placeholder=" Confirm Password">
                            <button type="submit" name="addUser" id="addUser">Register</button>
                            <span class="mt-3 text-white">Already have an account? <a href="login.php">Login</a></span>
                        </form>
                    </div>
                </div>
            </div>
