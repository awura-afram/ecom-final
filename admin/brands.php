                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="brand" id="basicInput" placeholder="Enter brand name" value="<?php
                                                                                                                                                        if (isset($_GET['editBrandID'])) {
                                                                                                                                                            echo $selected_brand['brand_name'];
                                                                                                                                                        }
                                                                                                                                                        ?>">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="actions">
                                                            <a href="<?php echo "../admin/brands.php?editBrandID=" . $brand['brand_id']; ?>"><i class="bi bi-pencil-fill"></i></a>
                                                            <span class="mx-2"></span>
                                                            <a href="<?php echo "../actions/processProducts.php?deleteBrandID=" . $brand['brand_id']; ?>"><i class="bi bi-trash-fill"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php
