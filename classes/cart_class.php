...
class Cart extends Connection
{
    ...
    function addSubscription($cid, $subtype, $substatus)
    {
        return $this->query("insert into subscriptions values ('$cid','$subtype', '$substatus')");
    }

    function unsubscribe_cls($cid, $subtype)
    {
        return $this->query("delete from subscriptions where customer_id='$cid' and subscription_type='$subtype'");
    }

    function select_sub_cls($cid, $subtype)
    {
        return $this->fetchOne("select * from subscriptions where customer_id='$cid' and subscription_type='$subtype'");
    }
}
