...
function add_subscription_ctr($cid, $subtype, $substatus)
{
    //create instance of the cart class
    $cart_instance = new Cart();
    //calls method from cart class
    return $cart_instance->addSubscription($cid, $subtype, $substatus);
}

function remove_subscription_ctr($cid, $subtype)
{
    //create instance of the cart class
    $cart_instance = new Cart();
    //calls method from cart class
    return $cart_instance->unsubscribe_cls($cid, $subtype);
}


function select_subscription_ctr($cid, $subtype)
{
    //create instance of the cart class
    $cart_instance = new Cart();
    //calls method from cart class
    return $cart_instance->select_sub_cls($cid, $subtype);
}
